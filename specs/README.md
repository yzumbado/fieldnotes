...
|---|---|---|
| `requirements.md` | Alpha requirements — 14 requirements with acceptance criteria | Complete |
...
grounded in two real projects that fieldnotes was built to solve:
...
That's the problem fieldnotes solves.
